Rails.application.routes.draw do
  ...
  get 'lair/start_all_daemons' => 'projects#daemon_start_all',
    as: :daemon_start_all
  get 'lair/stop_all_daemons'  => 'projects#daemon_stop_all',
    as: :daemon_stop_all
  ...
  get 'projects/:id/reference_datasets/:dataset/result/:result/:file' =>
    'projects#reference_dataset_result',
  ...
  get 'projects/:id/result/:result/:file' => 'projects#result',
    as: :project_result
  get 'projects/:id/result/:result' => 'projects#result_partial',
    as: :project_result_partial
  get 'projects/:id/ncbi_download' => 'projects#new_ncbi_download',
    as: :project_new_ncbi_download
  post 'projects/:id/ncbi_download' => 'projects#create_ncbi_download',
  ...
  get 'query_datasets/:id/result/:result/:file' => 'query_datasets#result',
    as: :query_dataset_result
  get 'query_datasets/:id/run_mytaxa_scan' => 'query_datasets#run_mytaxa_scan',
    as: :query_dataset_run_mytaxa_scan
  get 'query_datasets/:id/run_distances' => 'query_datasets#run_distances',
    as: :query_dataset_run_distances
  post 'query_datasets/:id/unread' => 'query_datasets#mark_unread',
    as: :query_dataset_mark_unread
  get 'query_datasets/:id/reactivate_dataset' => 'query_datasets#reactivate',
    as: :query_dataset_reactivate

  # Medoid clusters
  get 'medoid_clade/:project_id/:metric/:clade' => 'projects#medoid_clade',
    as: :medoid_clade
  get 'medoid_clade/:project_id/:metric/:clade/as' =>
    'projects#medoid_clade_as',
    as: :medoid_clade_as

  # RDP Classifier
  get 'rdp_classify/:project_id/:ds_name' => 'projects#rdp_classify',
    as: :rdp_classify
  get 'rdp_classify/:project_id/:ds_name/as' => 'projects#rdp_classify_as',
    as: :rdp_classify_as
